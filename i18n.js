...
(function () {
  ...
  var DICT = {
    ...
    'my.loginFirstTimeNote': { ja: 'リニューアル後の新サイトを初めてご利用の方へ: 以前のサイトのパスワードはお使いいただけません(ブラウザが自動入力したパスワードも対象外です)。', en: 'First time on our renewed site? Your old password won\'t work here — even if your browser autofills it.' },
    'my.loginFirstTimeLink': { ja: '「新規登録」はこちら →', en: 'Sign up here →' },
    'my.forgotFirstTimeNote': { ja: 'まだ一度も新サイトにログインしたことが無い方は、こちらではなく「新規登録」をお試しください。', en: 'If you\'ve never logged in to our new site before, please use "Sign up" instead of this page.' },
