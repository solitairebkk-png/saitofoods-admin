...
(function () {
  ...
  var DICT = {
    ...
    'my.loginFirstTimeNote': { ja: 'リニューアル後の新サイトを初めてご利用の方へ: 以前のサイトのパスワードはお使いいただけません(ブラウザが自動入力したパスワードも対象外です)。引継ぎに不具合がある場合は <a href=\"mailto:orders@saitofoods.com\">orders@saitofoods.com</a> までお問い合わせくださいませ。', en: 'First time on our renewed site? Your old password won\'t work here — even if your browser autofills it. If you run into trouble migrating your account, please contact us at <a href=\"mailto:orders@saitofoods.com\">orders@saitofoods.com</a>.' },
    'my.loginFirstTimeLink': { ja: '「新規登録」はこちら →', en: 'Sign up here →' },
    'my.forgotFirstTimeNote': { ja: 'まだ一度も新サイトにログインしたことが無い方は、こちらではなく「新規登録」をお試しください。引継ぎに不具合がある場合は <a href=\"mailto:orders@saitofoods.com\">orders@saitofoods.com</a> までお問い合わせくださいませ。', en: 'If you\'ve never logged in to our new site before, please use "Sign up" instead of this page. If you run into trouble migrating your account, please contact us at <a href=\"mailto:orders@saitofoods.com\">orders@saitofoods.com</a>.' },
