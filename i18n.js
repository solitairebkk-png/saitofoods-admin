...
(function () {
  ...
  var DICT = {
    ...
    'my.loginFirstTimeNote': { ja: '以前のサイトのパスワードはお使いいただけません(ブラウザの自動入力も対象外です)。今までお使いのメールアドレスで新しいパスワードを設定してください。設定後に届くメール内のリンクを押すと、ログインが完了します。<br>引継ぎに不具合がある場合は <a href=\"mailto:orders@saitofoods.com\">orders@saitofoods.com</a> までお問い合わせくださいませ。', en: 'Your old password won\'t work here — even if your browser autofills it. Please set a new password using the email address you used before. Click the link in the confirmation email to finish logging in.<br>If you run into trouble migrating your account, please contact us at <a href=\"mailto:orders@saitofoods.com\">orders@saitofoods.com</a>.' },
    ...
    'my.forgotFirstTimeNote': { ja: 'こちらのページからはログインできません。今までお使いのメールアドレスで、「新規登録」から新しいパスワードを設定してください。<br>引継ぎに不具合がある場合は <a href=\"mailto:orders@saitofoods.com\">orders@saitofoods.com</a> までお問い合わせくださいませ。', en: 'This page won\'t work for you yet. Please use "Sign up" to set a new password with the email address you used before.<br>If you run into trouble migrating your account, please contact us at <a href=\"mailto:orders@saitofoods.com\">orders@saitofoods.com</a>.' },
